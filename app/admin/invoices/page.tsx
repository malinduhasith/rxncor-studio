...
const noticeMessages: Record<string, string> = {
  ...
  send: "Document email with PDF accepted by the email provider. Check delivery monitoring for its status.",
  sent: "Document email accepted by the email provider.",
  resend: "Document email with PDF sent again.",
  reminder: "Payment reminder with invoice PDF sent.",
